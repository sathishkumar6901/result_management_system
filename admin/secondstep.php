    ...
    <header>
      ...
      <div class="main-content-header">
          ...
          <table class="table1">
             ...
             <tr>
                 <td><input type='text' name='tamil1' placeholder='Tamil' required/></td>
                 <td><input type='text' name='english1' placeholder='English' required/></td>
                 <td><input type='text' name='maths1' placeholder='Maths' required/></td>
             </tr>
             </table>
             <table class="table2">
             <tr>
         ...
         <table class="table4">
             ...
             <tr>
                 <td><input type='text' name='tamil2' placeholder='Tamil' required/></td>
                 <td><input type='text' name='english2' placeholder='English' required/></td>
                 <td><input type='text' name='maths2' placeholder='Maths' required/></td>
             </tr>
             </table>
             <table class="table2">
             <tr>
