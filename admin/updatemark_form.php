    ...
    <header>
      ...
      <div class="main-content-header">
          ...
          <table class="table1">
             ...
             <tr>
                <th>Tamil</th>   <th> English </th> <th>Maths</th>
             </tr>
             <tr>
                 <td>
                <input type='text' name='tamil1' value="<?php echo $data['u_tamil1']; ?>" class="th" required/></td>
                 <td><input type='text' name='english1' value="<?php echo $data['u_english1']; ?>" class="th"/></td>
                 <td><input type='text' name='maths1' value="<?php echo $data['u_maths1']; ?> " class="th" required/></td>
             </tr>
             </table>
             <table class="table2">
             <tr>
         ...
         <table class="table4">
             ...
             <tr>
                 <td><input type='text' name='tamil2' value="<?php echo $data['u_tamil2']; ?> " class="th" required/></td>
                 <td><input type='text' name='english2' value="<?php echo $data['u_english2']; ?> " class="th" required/></td>
                 <td><input type='text' name='maths2' value="<?php echo $data['u_maths2']; ?> " class="th" required/></td>
             </tr>
             </table>
             <table class="table2">
             <tr>
