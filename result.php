      ...
      <div class="main-content-header">
        <form method="post" action="result.php">
          ...
          <table class="table2">
              ...
              <th>Tamil</th>
                <th><?php echo $data2['u_tamil1']; ?></th>
                <th><?php echo $data2['u_tamil2']; ?></th>
                <th><?php echo $total1=$data2['u_tamil1']+$data2['u_tamil2']; ?> </th>
                <th>200</th>
              </tr>
              <tr>  
              <th>English</th>
              ...
              <th>Maths</th>
                  ...
                  <th><?php echo $total3=$data2['u_maths1']+$data2['u_maths2']; ?> </th>
                  <th>200</th>
              </tr>
              <tr>
              <th>Physics</th>
              ...
              <th>Total</th>
                  <th>
                   <?php echo $data2['u_tamil1']+$data2['u_english1']+$data2['u_maths1']+$data2['u_physics1']+$data2['u_chemestry1']; ?>
                  </th>
                  <th>
                  <?php echo $data2['u_tamil2']+$data2['u_english2']+$data2['u_maths2']+$data2['u_physics2']+$data2['u_chemestry']; ?>
                  </th>
